...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 버튼1-1 클릭 시 이벤트 처리
    const button1 = document.querySelector('.newsaveb .btn:nth-child(1)');
    if (button1) {
...
function createDocumentItem(container, data) {
    ...
    docItem.innerHTML = `
        ...
        <div class="summary">
            <div class="summary-text">${short_summary}</div>
            ...
            <div class="keywords">
                ...
                <div class="dropdown">
                    <button class="btn btn-sm folder-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        폴더
                    </button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">개발자의 삶</a></li>
                        <li><a class="dropdown-item" href="#">미국 대선 이슈</a></li>
...
function initializeTab2SearchEvents() {
    ...
    function executeTab2Search() {
        ...
        if (queryText) {
            searchTab2Documents(queryText, 'tab2-document-list');
...
// 검색 기능 구현
function searchTab2Documents(queryText, containerId) {
